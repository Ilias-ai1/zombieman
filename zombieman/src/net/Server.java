...
public class Server {
   ...
   void setPlayerData() {
      ...
      spieler[1] = new SpielerDaten(
         getMap()[Konstante.LIN - 2][Konstante.COL - 2].x - Konstante.VAR_X_SPRITES,   
         getMap()[Konstante.LIN - 2][Konstante.COL - 2].y - Konstante.VAR_Y_SPRITES
      );
      spieler[2] = new SpielerDaten(
         getMap()[Konstante.LIN - 2][1].x - Konstante.VAR_X_SPRITES,   
         getMap()[Konstante.LIN - 2][1].y - Konstante.VAR_Y_SPRITES
      );
      spieler[3] = new SpielerDaten(
         getMap()[1][Konstante.COL - 2].x - Konstante.VAR_X_SPRITES,   
